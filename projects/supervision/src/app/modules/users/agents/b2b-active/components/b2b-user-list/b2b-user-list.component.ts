...
const log = new Logger('users/B2bUserListComponent');
let filterArray: Array<any> = [];
let respDataCopy: Array<any> = [];


@Component({
    selector: 'app-b2b-user-list',
    templateUrl: './b2b-user-list.component.html',
    styleUrls: ['./b2b-user-list.component.scss']
})
export class B2bUserListComponent implements OnInit {
    ...
    getUserList(): void {
        ...
        if (statusFromRoute == 1) {
            const data = [{ auth_role_id: 2, status: true, offset: 0, limit: 10 }]
            data['topic'] = 'userList';
            ...
            const data = [{ auth_role_id: 2, status: false, offset: 0, limit: 10 }]
            data['topic'] = 'userList';

...
const log = new Logger('users/SupplierUserListComponent');
let filterArray: Array<any> = [];
let respDataCopy: Array<any> = [];


@Component({
    selector: 'app-supplier-user-list',
    templateUrl: './supplier-user-list.component.html',
    styleUrls: ['./supplier-user-list.component.scss']
})
export class SupplierUserListComponent implements OnInit {
    ...
    getUserList(): void {
        ...
        if (statusFromRoute == 1) {
            const data = [{ auth_role_id: 6, status: true, offset: 0, limit: 10 }]
            data['topic'] = 'userList';
            ...
            const data = [{ auth_role_id: 6, status: false, offset: 0, limit: 10 }]
            data['topic'] = 'userList';

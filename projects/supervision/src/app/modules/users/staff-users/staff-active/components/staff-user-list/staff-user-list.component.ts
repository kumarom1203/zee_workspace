...
const log = new Logger('users/StaffUserListComponent');
...
export class StaffUserListComponent implements OnInit {
    ...
    getUserList(): void {
        ...
        if (statusFromRoute == 1) {
            const data = [{ auth_role_id: 3, status: true, offset: 0, limit: 10 }]
            data['topic'] = 'userList';
            ...
            const data = [{ auth_role_id: 3, status: false, offset: 0, limit: 10 }]
            data['topic'] = 'userList';

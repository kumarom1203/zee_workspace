...
const log = new Logger('users/B2cUserListComponent');
let filterArray: Array<any> = [];
let respDataCopy: Array<any> = [];


@Component({
    selector: 'app-b2c-user-list',
    templateUrl: './b2c-user-list.component.html',
    styleUrls: ['./b2c-user-list.component.scss']
})
export class B2cUserListComponent implements OnInit {
    ...
    getUserList(): void {
        ...
        console.log(statusFromRoute)
        if (statusFromRoute == 1) {
            const data = [{ auth_role_id: 4, status: true, offset: 0, limit: 10 }]
            data['topic'] = 'userList';
            ...
            const data = [{ auth_role_id: 4, status: false, offset: 0, limit: 10 }]
            data['topic'] = 'userList';
